...
def send_to_homey(pokename, distance, homey_token):
    print('Send to Homey: ' + pokename)
    pokeinfo = {'event': 'pokemon', 'data1': pokename, 'data2': distance}
    requests.post("https://webhooks.athom.com/webhook/57274085acb3bd6d24b3d200/?token=" + homey_token, data=pokeinfo)
...
def get_args():
    ...
    parser.add_argument('-ht', '--homey-token', help='homey token', required=True)
...
def main():
    ...
    global homey_token
    homey_token = str(args.homey_token)
...
transform_from_wgs_to_gcj(Location(Fort.Latitude, Fort.Longitude))
    ...
    for poke in visible:
        ...
        if distance < max_distance:
            ...
            send_to_homey(pokename, distance, homey_token)
